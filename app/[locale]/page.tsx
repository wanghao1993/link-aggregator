      ...
      <main className="container mx-auto px-4 py-12">
          ...
          <section>
            <div className="flex items-center mb-8">
              <div className="flex-grow">
                <h2 className="text-3xl font-bold text-gray-900">{t('recent')}</h2>
        ...
        {featuredCollections.length === 0 && recentCollections.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 text-lg font-medium">No collections yet. Be the first to create one!</p>
          </div>
        )}
      </main>
    </div>
